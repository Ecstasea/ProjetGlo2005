...
('Crème de litchi'),
('Crème de goyave'),
('Crème de fruit de la passion'),
('Crème de mandarine'),
('Crème de mirabelle'),
('Crème de châtaigne');

-- Pour la table Categorie_recettes :
...
-- Pour la table Difficulte_recettes :
...
-- Pour la table Cuisinier_recettes
-- Lien entre les recettes et les cuisiniers
...
-- Ajoutez d'autres liens entre recettes et cuisiniers ici
